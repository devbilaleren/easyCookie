    ...
    $.easyCookie = function(name, value, options) {
        ...
        const cookie = {
            ...
            set: function (name, value){
                this.setDays(name, value, settings.expire);
